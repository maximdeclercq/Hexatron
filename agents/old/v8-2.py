...
def get_best_move_with_ray_casting(board: ndarray, player_position: ndarray, player_rotation: int, opponent_position: ndarray, opponent_rotation: int, player_playable_moves: list) -> int:
    ...
    for move in player_playable_moves:
        ...
        new_board[ray_position[1], ray_position[0], 0] = 1
...
def get_best_move_with_multi_ray_casting(board: ndarray, player_position: ndarray, player_rotation: int, opponent_position: ndarray, opponent_rotation: int, player_playable_moves:list, opponent_playable_moves:list) -> int:
    ...
    return max([(distance, move) for distance, move in distances if distance is not None])[1]
...
def get_best_move_with_flooding(board: ndarray, player_position: ndarray, player_rotation: int, opponent_position: ndarray, opponent_rotation: int, player_playable_moves:list, opponent_playable_moves:list) -> int:
    ...
    mx = max(ratings)[0]
    return get_best_move_with_multi_ray_casting(board, player_position, player_rotation, opponent_position, opponent_rotation, [move for rating, move in ratings if abs(mx - rating) < 1e-9], opponent_playable_moves)
...
def get_best_move(board: ndarray, player_position: ndarray, player_rotation: int, opponent_position: ndarray, opponent_rotation: int):
    ...
    if calculate_distance_between(board, player_position, opponent_position) is None:
        return get_best_move_with_ray_casting(board, player_position, player_rotation, opponent_position, opponent_rotation, player_playable_moves)
